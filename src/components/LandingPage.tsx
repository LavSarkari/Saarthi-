...
export default function LandingPage({ onLaunch, isLoggedIn }: LandingPageProps) {
  ...
  const getSimZone = (score: number) => {
    if (score >= 80) return { label: "Secured", color: "text-emerald-400", bg: "bg-emerald-500/10 border-emerald-500/20" };
    if (score >= 50) return { label: "Caution", color: "text-amber-400", bg: "bg-amber-500/10 border-amber-500/20" };
    return { label: "High Risk", color: "text-rose-400", bg: "bg-rose-500/10 border-rose-500/20" };
  };
  ...
  const ocrSamples = [
    {
      ...
      date: "Oct 12, 2026",
      extracted: [
        { title: "Database Architecture Midterm", deadline: "2026-10-15T10:00", d: "Chapters 1-6 coverage.", min: 180, conf: 98 },
        { title: "Relational Algebra Problem Set", deadline: "2026-10-18T23:59", d: "SQL parsing questions.", min: 120, conf: 95 }
      ]
    },
    {
      ...
      date: "Dec 04, 2026",
      extracted: [
        { title: "Calculus III Final Assessment", deadline: "2026-12-08T09:00", d: "Multivariable integration focus.", min: 300, conf: 91 },
        { title: "Linear Algebra Lab Sync", deadline: "2026-12-05T17:00", d: "Matlab vector transforms.", min: 90, conf: 88 }
      ]
    }
  ];
  ...
  const demoConversation = [
    { sender: "user", text: "Hey Saarthi, I have a massive Chemistry lab report due on Friday at 5 PM. I haven't started yet and I have an exam tomorrow." },
    { sender: "assistant", text: "I have calculated your Completion Confidence at 42% (High Risk) due to the tomorrow exam conflict. Let's establish a strict 3-step tactical recovery plan: 1. Core Synthesis (90m tonight), 2. Visual Graphs Mapping (60m Friday morning), 3. Executive Review (30m before submit). Let me schedule this safely around your exam slot." },
    { sender: "user", text: "That sounds completely doable. Lock that in." },
    { sender: "assistant", text: "Perfect. Recovery route locked. Subtasks written to Google Tasks and synced with Google Calendar. Your Completion Confidence has risen to 88% (Secured). Let's nail this." }
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-slate-100 font-sans selection:bg-indigo-600 selection:text-white relative overflow-hidden">
      ...
      {/* 1. HERO SECTION */}
      <section className="relative pt-20 pb-24 px-6 max-w-7xl mx-auto text-center space-y-8 z-10">
        {/* Flagship Badge */}
        ...
        <div className="pt-12 max-w-4xl mx-auto">
          <div className="bg-neutral-950/40 border border-white/5 rounded-3xl p-6 md:p-8 backdrop-blur-xl relative shadow-2xl">
              ...
              {centerpieceSteps.map((step, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className={`text-[9px] font-mono tracking-tight font-semibold ${isActive ? "text-white" : "text-slate-500"}`}>
                      {step.label}
                    </span>
                  </button>
                );
            ...
            <div className="py-10 grid grid-cols-1 md:grid-cols-12 gap-8 items-center text-left">
              <div className="md:col-span-7 space-y-4">
                <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-indigo-500/10 text-indigo-300 text-[10px] font-mono font-semibold">
                  ...
                  <span className="uppercase text-white animate-pulse">{centerpieceSteps[activeCenterpieceStep].status}</span>
                </div>
                ...
                <div className="pt-2 flex items-center gap-3">
                  <span className="text-[10px] font-mono text-slate-500">Security Index:</span>
              ...
              <div className="md:col-span-5 bg-white/2 rounded-2xl border border-white/5 p-6 space-y-4 relative overflow-hidden">
                ...
                <div className="flex items-center justify-between border-b border-white/5 pb-2">
                  <span className="text-[10px] font-mono text-slate-400">ACTIVE TASK PIPELINE</span>
                  <span className="text-[9px] font-mono text-indigo-400 animate-pulse">LIVE</span>
                </div>
                  ...
                  {centerpieceSteps.map((s, idx) => {
                    ...
                    return (
                      <div key={idx} className="flex items-center gap-3">
                        <div className={`w-2 h-2 rounded-full transition-all ${active ? "bg-indigo-400 shadow-lg shadow-indigo-400/50 scale-125" : "bg-neutral-800"}`} />
                        <div className="flex-1">
                          <div className="flex justify-between items-center text-[10px]">
                            <span className={active ? "text-slate-200 font-semibold" : "text-slate-600"}>{s.label.split(". ")[1]}</span>
                            {active && <span className="text-emerald-400 text-[8px] font-mono">OK</span>}
                          </div>
                          <div className="w-full bg-neutral-900 h-1 rounded-full mt-1 overflow-hidden">
                            <div className={`h-full bg-indigo-500 transition-all duration-1000 ${active ? "w-full" : "w-0"}`} />
                          </div>
                        </div>
                      </div>
                    );
      ...
      <section id="problem" className="py-24 border-t border-white/5 bg-[#030303] relative z-10">
        <div className="max-w-6xl mx-auto px-6 space-y-12">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            <h2 className="text-xs font-mono text-indigo-400 tracking-wider uppercase font-semibold">The Productivity Crisis</h2>
            <h3 className="text-3xl md:text-5xl font-bold font-display tracking-tight text-white">
              Reminders Don't Solve Procrastination.
            </h3>
            <p className="text-slate-400 text-xs md:text-sm leading-relaxed">
              Modern calendar pings and checklists assume humans are robots. When friction spikes or schedules overflow, traditional systems fail completely. Saarthi provides a dynamic protective system.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6">
            ...
            <div className="bg-neutral-950/60 border border-red-500/10 rounded-3xl p-8 space-y-6 relative overflow-hidden group hover:border-red-500/20 transition-all">
              ...
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-mono uppercase tracking-wider text-red-400 bg-red-500/10 px-2.5 py-0.5 rounded-md font-bold">Traditional Apps</span>
                <span className="text-[11px] font-mono text-slate-500">Unreactive Alerts</span>
              </div>
              <h4 className="text-xl font-bold text-slate-200">The Screen Fatigue Spiral</h4>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 p-3 bg-white/2 rounded-xl border border-white/5 opacity-80">
                  ...
                  <div>
                    <h5 className="text-xs font-bold text-slate-300">Unstructured Reminder</h5>
                    <p className="text-[10px] text-slate-500">A generic notification states: "Database Project Due tomorrow."</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-3 bg-white/2 rounded-xl border border-white/5 opacity-60">
                  ...
                  <div>
                    <h5 className="text-xs font-bold text-slate-300">Ignored Due to Friction</h5>
                    <p className="text-[10px] text-slate-500">You ignore it because starting is overwhelming and undefined.</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-3 bg-red-500/5 rounded-xl border border-red-500/10">
                  ...
                  <div>
                    <h5 className="text-xs font-bold text-red-400">Sudden Panic & Missed Deadline</h5>
                    <p className="text-[10px] text-red-400/80">Last-minute rush leads to severe fatigue, low quality, or failure.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-neutral-950/60 border border-indigo-500/20 rounded-3xl p-8 space-y-6 relative overflow-hidden group hover:border-indigo-500/40 transition-all shadow-xl shadow-indigo-950/20">
              ...
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-mono uppercase tracking-wider text-indigo-400 bg-indigo-500/15 px-2.5 py-0.5 rounded-md font-bold">Saarthi Execution Engine</span>
                <span className="text-[11px] font-mono text-emerald-400 flex items-center gap-1">
                  <span className="h-1.5 w-1.5 rounded-full bg-emerald-400 animate-pulse" /> Predictive AI
                </span>
              </div>
              <h4 className="text-xl font-bold text-white">Continuous Execution Guidance</h4>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 p-3 bg-indigo-500/5 rounded-xl border border-indigo-500/10">
                  ...
                  <div>
                    <h5 className="text-xs font-bold text-indigo-300">Automated Deconstruction</h5>
                    <p className="text-[10px] text-slate-400">AI parses the project into 4 action steps with suggested effort.</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-3 bg-emerald-500/5 rounded-xl border border-emerald-500/10">
                  ...
                  <div>
                    <h5 className="text-xs font-bold text-emerald-300">Completion Confidence Tracker</h5>
                    <p className="text-[10px] text-slate-400">Computes real-time execution risk based on your schedule.</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-3 bg-purple-500/5 rounded-xl border border-purple-500/10">
                  ...
                  <div>
                    <h5 className="text-xs font-bold text-purple-300">Compromise & Rescue Strategy</h5>
                    <p className="text-[10px] text-slate-400">Flags overload conflicts and suggests custom operational recoveries.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="innovation" className="py-24 border-t border-white/5 bg-black relative overflow-hidden z-10">
        ...
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-slate-400 text-xs md:text-sm leading-relaxed">
              Our core algorithm continuously profiles the feasibility of your commitments. Adjust the simulation variables to see how Saarthi dynamically protects your on-time execution.
            </p>
            ...
            <div className="space-y-4 pt-4 border-t border-white/5">
              <div className="flex gap-3 items-start">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-200">Execution Velocity Index</h4>
                  <p className="text-[11px] text-slate-400">Tracks how fast you complete micro-tasks versus deadlines.</p>
                </div>
              </div>
              ...
              <div className="flex gap-3 items-start">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-200">Recovery Impact Safeguard</h4>
                  <p className="text-[11px] text-slate-400">Restores confidence immediately once a structured tactical rescue plan is accepted.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 bg-neutral-950/60 border border-white/10 rounded-3xl p-6 md:p-8 backdrop-blur-xl space-y-8 relative shadow-2xl">
            <div className="flex items-center justify-between border-b border-white/5 pb-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold font-mono text-slate-300 uppercase tracking-wider">Dynamic Risk Simulator</span>
              </div>
              <button 
                onClick={() => {
                  setSimTasksCount(4);
            ...
            <div className={`p-5 rounded-2xl border transition-all flex flex-col md:flex-row items-center justify-between gap-6 ${simZone.bg}`}>
              <div className="text-center md:text-left space-y-1">
                <span className="text-[9px] font-mono text-slate-400 uppercase tracking-wider">Computed Feasibility Zone</span>
                <div className="flex items-baseline gap-2 justify-center md:justify-start">
                  <span className="text-3xl font-black text-white font-mono">{simConfidence}%</span>
                  <span className={`text-xs font-bold ${simZone.color}`}>{simZone.label}</span>
                </div>
              ...
              <div className="relative w-24 h-24 flex items-center justify-center">
                <svg className="w-full h-full transform -rotate-90" viewBox="0 0 36 36">
                  ...
                  <path
                    className={`transition-all duration-500 ${
                      simConfidence >= 80 ? "text-emerald-500" : simConfidence >= 50 ? "text-amber-500" : "text-rose-500"
                    }`}
                ...
                <div className="absolute text-center">
                  <span className="text-xs font-mono font-bold text-white">{simConfidence}%</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                <div className="flex justify-between text-[11px] font-mono">
                  <span className="text-slate-400">Incomplete Commitment Steps:</span>
                  <span className="text-white font-bold">{simTasksCount} steps</span>
                </div>
                <input
                  type="range"
                  min="1"
              ...
              <div className="space-y-1">
                <div className="flex justify-between text-[11px] font-mono">
                  <span className="text-slate-400">Hours Remaining Until Due:</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  <div className="flex justify-between text-[11px] font-mono">
                    ...
                    <span className="text-white font-bold">Lvl {simComplexity}/5</span>
                  </div>
                  <input
                    type="range"
                    min="1"
                ...
                <div className="space-y-1">
                  <div className="flex justify-between text-[11px] font-mono">
                    <span className="text-slate-400">Pre-Exam Sleep Buffer:</span>
                    <span className="text-white font-bold">{simSleep} Hours</span>
                  </div>
                  <input
                    type="range"
                    min="4"
              ...
              <div className="pt-4 border-t border-white/5 flex items-center justify-between bg-white/2 p-3.5 rounded-xl border border-white/5">
                <div className="space-y-0.5">
                  <span className="text-xs font-bold text-slate-200 block">Arm Strategic Compromise Recovery Plan</span>
                  <p className="text-[10px] text-slate-400">Redistributes focus tasks to secure the absolute baseline passing threshold.</p>
                </div>
                <button
      ...
      <section id="features" className="py-24 border-t border-white/5 bg-[#030303] relative z-10">
        <div className="max-w-6xl mx-auto px-6 space-y-12">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            <h2 className="text-xs font-mono text-indigo-400 tracking-wider uppercase font-semibold">The Saarthi Toolbox</h2>
            <h3 className="text-3xl md:text-5xl font-bold font-display tracking-tight text-white">
              Every Tool Formed For Execution.
            </h3>
            <p className="text-slate-400 text-xs md:text-sm leading-relaxed">
              We ditched generic lists. Every single feature inside Saarthi integrates directly with Google models to reduce initial cognitive drag.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6 space-y-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 bg-neutral-950 border border-white/10 rounded-3xl p-6 relative overflow-hidden shadow-2xl">
              ...
              <div className="flex items-center justify-between border-b border-white/5 pb-4 mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-mono font-bold text-slate-200">Syllabus OCR Extract Preview</span>
                </div>
                {/* Switcher */}
                  ...
                  {ocrSamples.map((s, idx) => (
                    <button
                      ...
                      className={`px-3 py-1 text-[9px] font-mono rounded-md border transition-all cursor-pointer ${
                        ocrSampleIndex === idx ? "bg-white/10 border-white/20 text-white" : "bg-transparent border-white/5 text-slate-500 hover:text-slate-300"
                      }`}
                    >
                      {s.title}
                    </button>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-white/2 border border-white/5 rounded-2xl flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                  <div>
                    <h4 className="text-xs font-bold text-slate-300">File Legibility Verification</h4>
                    <p className="text-[10px] text-slate-500">Scanned on {ocrSamples[ocrSampleIndex].date}</p>
                  </div>
                ...
                <div className="space-y-3">
                  <span className="text-[9px] font-mono text-slate-500 block uppercase">Extracted Commitments</span>
                  {ocrSamples[ocrSampleIndex].extracted.map((c, idx) => (
                    <div key={idx} className="p-4 bg-neutral-900/60 border border-white/5 rounded-2xl space-y-2 hover:border-indigo-500/20 transition-all">
            ...
            <div className="lg:col-span-5 space-y-6 text-left">
              ...
              <p className="text-slate-400 text-xs md:text-sm leading-relaxed">
                Don't waste time typing lengthy syllabus details or copy-pasting homework guidelines. Snap a quick photo with your phone or drag-and-drop screenshots of documents.
              </p>
              ...
              <div className="space-y-3 pt-4 border-t border-white/5">
                {[
                  ...
                  <div key={index} className="flex items-center gap-3 text-[11px] font-mono text-slate-300">
      ...
      <section id="google" className="py-24 border-t border-white/5 bg-[#030303] relative z-10">
        <div className="max-w-6xl mx-auto px-6 space-y-12">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            <h2 className="text-xs font-mono text-indigo-400 tracking-wider uppercase font-semibold">Under the Hood</h2>
            <h3 className="text-3xl md:text-5xl font-bold font-display tracking-tight text-white">
              Google Cloud & Gemini Synergy.
            </h3>
            <p className="text-slate-400 text-xs md:text-sm leading-relaxed">
              Saarthi is fully built within the Google Cloud Run ecosystem, incorporating real-time AI and durable storage architectures.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-6">
            <div className="p-6 bg-white/2 border border-white/5 rounded-3xl space-y-3 hover:border-indigo-500/10 transition-all">
              <span className="text-[9px] font-mono text-indigo-400 uppercase tracking-wider block font-bold">Primary Model</span>
              <h4 className="text-base font-bold text-slate-200">Gemini 3.5 Flash</h4>
              <p className="text-xs text-slate-400">
                Powers real-time decomposition and tactical task strategy generation with high logical throughput.
              </p>
            </div>

            <div className="p-6 bg-white/2 border border-white/5 rounded-3xl space-y-3 hover:border-indigo-500/10 transition-all">
              <span className="text-[9px] font-mono text-indigo-400 uppercase tracking-wider block font-bold">Vision Engine</span>
              <h4 className="text-base font-bold text-slate-200">Gemini Vision (OCR)</h4>
              <p className="text-xs text-slate-400">
                Scans complicated PDFs, lecture slides, and physical documents to read and structure target dates.
              </p>
            </div>

            <div className="p-6 bg-white/2 border border-white/5 rounded-3xl space-y-3 hover:border-indigo-500/10 transition-all">
              <span className="text-[9px] font-mono text-indigo-400 uppercase tracking-wider block font-bold">Live Consultation</span>
              <h4 className="text-base font-bold text-slate-200">Gemini Live API</h4>
              <p className="text-xs text-slate-400">
                Establishes bidirectional PCM voice WebSockets for natural spoken productivity reviews.
              </p>
            </div>

            <div className="p-6 bg-white/2 border border-white/5 rounded-3xl space-y-3 hover:border-indigo-500/10 transition-all">
              <span className="text-[9px] font-mono text-indigo-400 uppercase tracking-wider block font-bold">Real-time DB</span>
              <h4 className="text-base font-bold text-slate-200">Firebase & Firestore</h4>
              <p className="text-xs text-slate-400">
                Persists user commitments, historical activity, and settings with low-latency client subscriptions.
              </p>
            </div>

            <div className="p-6 bg-white/2 border border-white/5 rounded-3xl space-y-3 hover:border-indigo-500/10 transition-all">
              <span className="text-[9px] font-mono text-indigo-400 uppercase tracking-wider block font-bold">Secure Access</span>
              <h4 className="text-base font-bold text-slate-200">Firebase Authentication</h4>
              <p className="text-xs text-slate-400">
                Safeguards private schedules with encrypted OAuth credentials and direct profile mapping.
              </p>
            </div>

            <div className="p-6 bg-white/2 border border-white/5 rounded-3xl space-y-3 hover:border-indigo-500/10 transition-all">
              <span className="text-[9px] font-mono text-indigo-400 uppercase tracking-wider block font-bold">Integrations</span>
              <h4 className="text-base font-bold text-slate-200">Google Calendar & Tasks</h4>
              <p className="text-xs text-slate-400">
                Direct write-back integrations provide standard synchronization with default calendar screens.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 border-t border-white/5 bg-black relative z-10">
        <div className="max-w-6xl mx-auto px-6 space-y-12">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            <h2 className="text-xs font-mono text-indigo-400 tracking-wider uppercase font-semibold">Visual Interface</h2>
            <h3 className="text-3xl md:text-5xl font-bold font-display tracking-tight text-white">
              The Command Center.
            </h3>
            <p className="text-slate-400 text-xs md:text-sm leading-relaxed">
              Explore the clean, data-dense layout of the Saarthi Workspace designed for desktop-first clarity and performance.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className="md:col-span-4 bg-neutral-950 border border-white/5 rounded-3xl p-6 flex flex-col justify-between space-y-8 relative overflow-hidden">
              <div className="space-y-1">
                <span className="text-[9px] font-mono text-indigo-400 uppercase tracking-wider block font-bold">Active Engine</span>
                <h4 className="text-base font-bold text-slate-200">Average Confidence</h4>
              </div>

              <div className="flex items-center gap-4">
                <span className="text-5xl font-black text-white font-mono">84%</span>
                <div>
                  <span className="text-emerald-400 font-bold text-xs flex items-center gap-1">
                    <TrendingUp className="w-3.5 h-3.5" /> +12% this week
                  </span>
                  <p className="text-[10px] text-slate-500">Recovery plans active.</p>
                </div>
              </div>
            </div>
            ...
            <div className="md:col-span-8 bg-neutral-950 border border-white/5 rounded-3xl p-6 space-y-4">
              <div className="flex justify-between items-center border-b border-white/5 pb-2">
                <span className="text-[10px] font-mono text-slate-400 uppercase">Tracked Commitments</span>
                <span className="text-[9px] font-mono text-indigo-400">3 ACTIVE</span>
              </div>

              <div className="space-y-2">
                <div className="flex justify-between items-center p-3 bg-white/2 rounded-xl">
                  <div>
                    <h5 className="text-xs font-bold text-white">Database Normalization Homework</h5>
                    <p className="text-[9px] text-slate-500">Decomposed to 4 items.</p>
                  </div>
                  <span className="text-[10px] font-mono text-rose-400 bg-rose-400/10 px-2 py-0.5 rounded">High Priority</span>
                </div>

                <div className="flex justify-between items-center p-3 bg-white/2 rounded-xl">
                  <div>
                    <h5 className="text-xs font-bold text-white">Advanced Calculus Exam Review</h5>
                    <p className="text-[9px] text-slate-500">Timed interval calendar sync.</p>
                  </div>
                  <span className="text-[10px] font-mono text-emerald-400 bg-emerald-400/10 px-2 py-0.5 rounded">Secured</span>
                </div>
              </div>
            </div>
            ...
            <div className="md:col-span-7 bg-neutral-950 border border-white/5 rounded-3xl p-6 space-y-4">
              <div className="flex justify-between items-center border-b border-white/5 pb-2">
                <span className="text-[10px] font-mono text-slate-400 uppercase">Live Advisor Feed</span>
                <span className="text-[9px] font-mono text-indigo-400">COACH ACTIVE</span>
              </div>

              <div className="p-4 bg-indigo-500/5 border border-indigo-500/10 rounded-2xl">
                <p className="text-xs text-indigo-300 italic">
                  "Calculus test has high task density. I have carved out a 90-minute block on Friday morning for final synthesis. Your calendar is clear."
                </p>
                <div className="flex items-center gap-2 mt-3">
                  ...
                  <span className="text-[9px] font-mono text-slate-400">Saarthi Strategic Advisor</span>
                </div>
              </div>
            </div>
            ...
            <div className="md:col-span-5 bg-neutral-950 border border-white/5 rounded-3xl p-6 flex flex-col justify-between space-y-4">
              <span className="text-[10px] font-mono text-slate-400 uppercase border-b border-white/5 pb-2 block">Sync Pipelines</span>
              <div className="grid grid-cols-2 gap-4">
                <div className="p-3 bg-white/2 rounded-xl text-center space-y-1">
                  <span className="text-[10px] text-slate-500">Google Calendar</span>
                  <div className="text-xs font-bold text-emerald-400">Active (Sync)</div>
                </div>
                <div className="p-3 bg-white/2 rounded-xl text-center space-y-1">
                  <span className="text-[10px] text-slate-500">Google Tasks</span>
                  <div className="text-xs font-bold text-emerald-400">Active (Sync)</div>
                </div>
              </div>
            </div>
      ...
      <section className="py-32 border-t border-white/5 bg-gradient-to-b from-black to-neutral-950 relative overflow-hidden z-10 text-center px-6">
        ...
        <div className="max-w-3xl mx-auto space-y-8 relative">
          <h2 className="text-4xl md:text-6xl font-bold font-display tracking-tight text-white leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-emerald-400">Your Success Should Too.</span>
          </h2>
          <p className="text-slate-400 text-sm md:text-base max-w-xl mx-auto">
            Break free from the stressful alarm schedules. Start planning with proactive AI support and lock down your goals today.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-display font-bold text-sm tracking-tight text-white">Saarthi</span>
            </div>
            <p className="text-[11px] text-slate-500 max-w-xs leading-relaxed">
              Saarthi is an advanced AI Execution Partner created for high-stress academic and professional workflows. Built on the Google Cloud platform.
            </p>
          ...
          <div className="space-y-3">
            <h5 className="font-mono text-[10px] text-slate-300 uppercase tracking-wider font-bold">Product</h5>
            <ul className="space-y-2 text-slate-500">
              <li><button onClick={onLaunch} className="hover:text-white transition-colors cursor-pointer text-left">Launch Workspace</button></li>
              <li><a href="#features" className="hover:text-white transition-colors">Features</a></li>
              <li><a href="#innovation" className="hover:text-white transition-colors">Confidence Algorithm</a></li>
            </ul>
          </div>

          <div className="space-y-3">
            <h5 className="font-mono text-[10px] text-slate-300 uppercase tracking-wider font-bold">Technology</h5>
            <ul className="space-y-2 text-slate-500">
              <li><a href="https://ai.google.dev" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">Gemini 3.5</a></li>
              <li><a href="https://firebase.google.com" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">Firebase Cloud</a></li>
              <li><a href="https://calendar.google.com" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">Google Calendar API</a></li>
            </ul>
          </div>

          <div className="space-y-3">
            <h5 className="font-mono text-[10px] text-slate-300 uppercase tracking-wider font-bold">Developer</h5>
            <div className="text-[11px] text-slate-500 leading-relaxed">
              Designed as a flagship Google AI submission for extreme productivity enablement.
            </div>
          </div>
            ...
            >
              <div className="flex items-center justify-between border-b border-white/5 pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-mono font-bold text-white uppercase tracking-wider">Simulated AI Voice Walkthrough</span>
                </div>
                <button
                  onClick={() => {
                ...
                {demoConversation.slice(0, demoStep + 1).map((msg, idx) => (
                  <div key={idx} className={`flex flex-col ${msg.sender === "user" ? "items-end" : "items-start"}`}>
                    ...
                    <div className={`p-3 rounded-2xl text-xs max-w-[85%] leading-relaxed ${
                      msg.sender === "user" ? "bg-indigo-600 text-white rounded-tr-none" : "bg-white/5 text-slate-200 rounded-tl-none border border-white/5"
                    }`}>
                      {msg.text}
                    </div>
                  </div>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-white/5">
                <span className="text-[10px] font-mono text-slate-500">Dialogue {demoStep + 1} of {demoConversation.length}</span>
                <div className="flex gap-2">
